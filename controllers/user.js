...
const verify_otp = async(req, res, next) =>{
    const {otp_code, phone_number, is_sign_up, first_name, last_name, gender, address, dob, blood_type, emergency_contact, vehicle_name, vehicle_number, vehicle_color} = req.body;
    const country_code = "+91"
    try {
        const new_user = new User({first_name, last_name, phone_no: phone_number, gender, address, dob, blood_type, emergency_contact, vehicle_name, vehicle_number, vehicle_color});
...
module.exports = { get_user, get_user_by_phone_number, send_otp, verify_otp };
